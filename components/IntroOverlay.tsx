    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          {/* Floating Gradient Orbs - Light Theme */}
          <motion.div
            animate={{
              x: [0, 100, 0],
              y: [0, -50, 0],
          ...
          {[...Array(20)].map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                width: `${3 + (i % 3)}px`,
                height: `${3 + (i % 3)}px`,
                background: i % 3 === 0 ? 'rgba(236, 72, 153, 0.6)' : 
                           i % 3 === 1 ? 'rgba(168, 85, 247, 0.6)' : 'rgba(99, 102, 241, 0.6)',
                boxShadow: `0 0 ${8 + (i % 3) * 3}px ${i % 3 === 0 ? 'rgba(236, 72, 153, 0.4)' : 
                           i % 3 === 1 ? 'rgba(168, 85, 247, 0.4)' : 'rgba(99, 102, 241, 0.4)'}`
              }}
            />
          ))}
        </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="absolute top-8 right-8 z-10 flex items-center space-x-2 px-4 py-2 bg-white/20 backdrop-blur-xl border border-white/30 rounded-xl text-gray-700 hover:text-gray-900 transition-all duration-300 shadow-lg"
          style={{
          ...
          >
            ...
            <div className="p-12 text-center">
              ...
              <motion.div
                ...
                className="mb-6"
              >
                <div className={`w-20 h-20 rounded-3xl bg-gradient-to-r ${currentSection?.color} flex items-center justify-center mx-auto shadow-xl`}>
                  {currentSection?.icon && React.createElement(currentSection.icon, { className: "w-10 h-10 text-white" })}
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="min-h-[150px] flex flex-col items-center justify-center"
              >
                <h1 
                  className="text-2xl md:text-3xl font-bold text-gray-900 leading-tight mb-4 text-center"
                  style={{ 
                ...
                {titleComplete && (
                  <p 
                    className="text-lg text-gray-700 leading-relaxed max-w-4xl text-center px-4"
                    style={{ 
                      fontFamily: 'system-ui, sans-serif',
                      fontWeight: '400'
                    }}
              ...
              {narrativeStep < sections.length - 1 && titleComplete && contentComplete && (
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center space-x-2 px-6 py-3 bg-white/20 backdrop-blur-xl border border-white/30 rounded-xl text-gray-700 hover:text-gray-900 transition-all duration-300 mx-auto"
                    style={{
                      background: 'rgba(255, 255, 255, 0.25)',
                      backdropFilter: 'blur(15px)',
                      border: '1px solid rgba(255, 255, 255, 0.3)'
                  ...
                  >
                    <SkipForward className="w-4 h-4" />
                    <span className="text-sm font-medium">Skip to Next Section</span>
                  </motion.button>
                </motion.div>
              )}
              ...
              {narrativeStep === sections.length - 1 && titleComplete && contentComplete && (
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="relative text-white px-10 py-4 rounded-xl font-bold text-lg transition-all duration-300 flex items-center space-x-3 overflow-hidden"
                    style={{
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="text-gray-600 hover:text-gray-800 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 border border-gray-300 hover:border-gray-400"
                    style={{
